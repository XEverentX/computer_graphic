...
uniform vec3 TETR_SIZE;
uniform vec3 TETR_CENTER;
uniform vec3 TETR_COLOR;
...
void initializeDefaultScene( out STriangle triangles[TRIANGLES_COUNT], out SSphere spheres[SPHERES_COUNT] ) {
	...
	triangles[10].v1 = vec3( TETR_CENTER.x, TETR_CENTER.y, TETR_CENTER.z);
	triangles[10].v2 = vec3( TETR_CENTER.x, TETR_CENTER.y, (TETR_CENTER.z - TETR_SIZE.x));
	triangles[10].v3 = vec3( (TETR_CENTER.x - TETR_SIZE.x * SQRT_3 / 2.0), TETR_CENTER.y, (TETR_CENTER.z - TETR_SIZE.x / 2.0));
	triangles[10].MaterialIdx = int(TETR_COLOR.x);
	
	triangles[11].v1 = vec3( TETR_CENTER.x, TETR_CENTER.y, TETR_CENTER.z);
	triangles[11].v2 = vec3( (TETR_CENTER.x - TETR_SIZE.x * SQRT_3 / 2.0), TETR_CENTER.y, (TETR_CENTER.z - TETR_SIZE.x / 2.0));
	triangles[11].v3 = vec3( (TETR_CENTER.x - TETR_SIZE.x * SQRT_3 / 6.0), (TETR_CENTER.y + TETR_SIZE.x *  SQRT_6 / 3.0), (TETR_CENTER.z - TETR_SIZE.x / 2.0));
	triangles[11].MaterialIdx = int(TETR_COLOR.x);

	triangles[12].v1 = vec3( TETR_CENTER.x, TETR_CENTER.y , TETR_CENTER.z);
	triangles[12].v2 = vec3( TETR_CENTER.x, TETR_CENTER.y, (TETR_CENTER.z - TETR_SIZE.x));
	triangles[12].v3 = vec3( (TETR_CENTER.x - TETR_SIZE.x * SQRT_3 / 6.0), (TETR_CENTER.y + TETR_SIZE.x *  SQRT_6 / 3.0), (TETR_CENTER.z - TETR_SIZE.x / 2.0));
	triangles[12].MaterialIdx = int(TETR_COLOR.x);

	triangles[13].v1 = vec3( (TETR_CENTER.x - TETR_SIZE.x * SQRT_3 / 2.0), TETR_CENTER.y, (TETR_CENTER.z - TETR_SIZE.x / 2.0));
	triangles[13].v2 = vec3( TETR_CENTER.x, TETR_CENTER.y, (TETR_CENTER.z - TETR_SIZE.x));
	triangles[13].v3 = vec3( (TETR_CENTER.x - TETR_SIZE.x * SQRT_3 / 6.0), (TETR_CENTER.y + TETR_SIZE.x *  SQRT_6 / 3.0), (TETR_CENTER.z - TETR_SIZE.x / 2.0));
	triangles[13].MaterialIdx = int(TETR_COLOR.x); 
	
	/** SPHERES **/
	
	spheres[0].Center = vec3(2.0,0.5,2.0);
